...
Predict specific values of gut retention from body mass data for just the EXTINCT MEGAFAUNA FRUGIVOROUS species, and using van Soest's equation modified for time- and digestion-limited herbivores.  
